...
window.CLIPS = {
  ...
  "russian": [
    ...
    {"id":"yt-nhfUnNmFARg","kind":"yt","videoId":"nhfUnNmFARg","label":"Kharkiv, Ukraine","lang":"Russian","lat":49.9935,"lng":36.2304,"r":110,"start":129,"gain":100,"hint":"Streamed from YouTube — the creator gets the view.","gate":{"model":"gemini-3.5-flash","heard":"Kharkiv, Ukraine","offBy":1,"confidence":85,"evidence":["using the word 'город' instead of 'місто' for city","mentioning Belgorod as a nearby reference point","the characteristic Ukrainian voiced glottal 'h' sound"],"title":"Опрос на Марше единства: «что для вас настоящий Харьков?»","author":"Медіагрупа «Накипіло»"},"deck":"russian","evalExclude":true,"source":{"who":"Медіагрупа «Накипіло»","host":"YouTube","license":"Streamed from YouTube — the creator keeps the view","page":"https://www.youtube.com/watch?v=nhfUnNmFARg","note":"Опрос на Марше единства: «что для вас настоящий Харьков?»"}},

...
// Languages stream from Wikimedia Commons; accent clips are mirrored locally from the
// Speech Accent Archive (accent.gmu.edu) under CC BY-NC-SA with attribution.
window.CLIPS = {
  "languages": [
    {
      "id": "lang-kazakh",
